...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_ckt to login script."
...
# the current dir:
if   test x${GTLANG_ckt} = x ; then
	echo "WARNING: The variable \${GTLANG_ckt} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_ckt} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_ckt} has the value:"
	echo "  ${GTLANG_ckt}"
