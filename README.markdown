...
This directory contains source files for the Chukot language morphology
...
In order to compile and use Chukot language morphology and dictionaries,
you need:
...
The Chukot language sources can be acquired using [giella SVN
